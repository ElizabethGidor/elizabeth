...
<body>
  <nav class="navbar navbar-expand-lg ">
    <div class="container">
      <img src="OIP.jpg" alt="" class="DOOR">
  ...
  <!--head section-->
  <div id="banner" class="d-flex align-items-center" role="search">
    <div class="container">
      <div class="row">
        <div class="col-1g-12">
          <h1>
 ...
 <?php include 'about.php'; ?>
      ...
      <div class="row row-cols-lg-3">
        <div class="col d-flex justify-content-center">
          <div class="card" style="width: 24rem;">
            <img src="image1.jpg" class="card-img-top mx-auto" alt="...">
  ...
  <!-- REVIEWS -->
   <section id="reviews">
    <div cxlass="containert">
      <div class="text-center">
        <h2>REVIEWS</h2>
        <P>Lorem ipsum dolor sit amet consectetur adipipiscing </P>
      </div>
    </div>
   ...
   <div class="row row-cols-lg-2">
    <div class="col">
      <div class="testimonal">
        ...
        <p classs="text light mt3"> Insanity: doing the same thing over and over again and expecting different results. Albert Einstein </p>
      </div>
    </div>
    <div class="col">
      <div class="testimonal">
